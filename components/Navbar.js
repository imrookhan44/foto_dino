...
const Navbar = () => {
  ...
  const [photographer_link, setPhotLink] = useState("");
  const [secretary_link, setSecLink] = useState("");
  ...
  useEffect(() => {
    ...
    setLink(prot + "://next." + domain);
    setPhotLink(prot + "://photographer." + domain);
    setSecLink(prot + "://secretary." + domain);
      ...
      <button
        ...
        {login && (
          <div className="absolute bg-white top-7 right-0 border-2 border-light-grey rounded">
            <Link href={photographer_link} target="_blank" rel="noreferrer">
            ...
            <Link href={secretary_link} target="_blank" rel="noreferrer">
              <button className="px-4 py-2 border-b-2 border-light-grey hover:brightness-[0.9]">
                Secretary
              </button>
            </Link>

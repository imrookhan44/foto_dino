          ...
          <div className="md:col-span-2 rows-span-2 xs:p-10 p-3">
            {!showContact ? (
              <div className="flex flex-col items-center py-20">
                <h2 className="md:text-xl xs:text-3xl text-xl font-oswald mb-5 text-center">
                  Du möchtest deinen Termin ändern oder stornieren?
                </h2>

                <button
                  type="button"
                  onClick={() => setCancel(true)}
                  className="bg-red/10 border-[1px] border-red drop-shadow-lg px-4 py-2 xs:text-base text-sm rounded drop-shadow-lg"
                >
                  {translate("cancel_appointment")}
                </button>

                <h2 className="md:text-xl xs:text-3xl text-xl font-oswald mb-5 text-center mt-10">
                  Du hast eine Frage?
                </h2>
                ...
                <button
                  ...
                  className="bg-yellow px-4 py-2 xs:text-base text-sm rounded"
                >
                  kontaktiere uns
                </button>
              </div>
